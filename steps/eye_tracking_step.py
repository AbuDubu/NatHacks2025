"""
Step 5: Eye-Tracking Assessment (placeholder)
"""
...
class EyeTrackingStep(BaseStepFrame):
    """Step 5: Eye-Tracking Assessment (placeholder)"""
    
    def populate(self) -> None:
        header = ttk.Label(
            self,
            text="Eye-Tracking Assessment",
    ...
    def collect_data(self) -> None:
        self.app.assessment_state["eye_tracking"]["status"] = "placeholder"
